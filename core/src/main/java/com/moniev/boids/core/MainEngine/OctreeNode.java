...
public class OctreeNode {
    ...
    public OctreeNode(Vector center, float size, int boidsLimit, int depthLimit, OctreeNode parent, ModelBuilder modelBuilder, Octree tree) {
        this.tree = tree;
        this.parent = parent;
    ...
    public void subdivide() {
        for(int i = 0; i < 8; i++) {
            ...
            children[i] = new OctreeNode(childCenter, halfSize, boidsLimit, depthLimit - 1, this, modelBuilder, this.tree);
        }
        isLeaf = false; 
    }
    ...
    public boolean isNearBorder(Boid boid) {
        ...
        return (
            boid.position.x - margin < minX || boid.position.x + margin > maxX ||
